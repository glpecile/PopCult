...
function MediaCard(props) {
    return (
        <div
            className="flex flex-col bg-white rounded-lg shadow-md hover:shadow-indigo-500/50 group transition duration-300 ease-in-out hover:bg-violet-50/25 transform hover:-translate-1 hover:scale-105 active:scale-95">
