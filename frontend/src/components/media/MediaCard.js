...
function MediaCard(props) {
    ...
    return (
        <Link className="text-decoration-none" to={'/media/' + mediaType + '/' + props.id}>
            <div
                className="flex flex-col h-full bg-white rounded-lg shadow-md hover:shadow-indigo-500/50 group transition duration-300 ease-in-out hover:bg-violet-50/50 transform hover:-translate-1 hover:scale-[1.025] active:scale-95">
