...
function MediaCard(props) {
    return (
        <Link className="text-decoration-none" to={'/media/' + props.type + '/' + props.id}>
            <div
                ...
                <div
                    className="inline-block text-left tracking-tight whitespace-normal text-gray-800 group-hover:text-purple-900 font-medium text-lg p-1.5 m-2.5">
