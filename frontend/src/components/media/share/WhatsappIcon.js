    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <IconButton
                ...
                className="rounded-full bg-green-400 w-20 h-20 flex items-center justify-center transition duration-300 ease-in-out transform hover:-translate-1 hover:scale-105 active:scale-90">
