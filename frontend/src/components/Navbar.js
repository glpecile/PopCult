...
function Navbar() {
    return (
        <nav
            className="pb-3 pt-3 navbar navbar-expand-lg w-full navbar-dark bg-dark text-white shadow-md bg-gradient-to-r from-yellow-500 to-purple-900">
            <div className="flex justify-between items-center sm:px-12 px-16">
                <NavLink className="navbar-brand m-0 p-0" to='/'>
                    <img
                        ...
                        src={require('./PopCultCompleteLogo.png')}
                ...
                <div
                    ...
                    id="navbarScroll">
                    <ul className="navbar-nav flex ms-auto my-2 my-lg-0">
                        {/*si se saca el flex de esta ul los elementos se ponen verticales*/}
                        <li className=" flex nav-item transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
