...
public class SearchController {
    ...
    public ModelAndView search(HttpServletRequest request,
        ...
        final PageContainer<Media> searchMediaResults = searchService.searchMediaByTitle(searchForm.getTerm(),page-1,itemsPerPage, mediaTypes,SortType.valueOf(searchForm.getSortType().toUpperCase()).ordinal(), genres, searchForm.getDecade(), searchForm.getDecade());
