...
<head>
    ...
    <title><spring:message code="report.list.title"/> &#8226; PopCult</title>
</head>
...
<div class="min-h-screen flex flex-col">
    ...
    <div class="col-8 offset-2 flex-grow">
        <div class="row g-3 p-2 my-8 bg-white shadow-lg rounded-lg">
            <h2 class="text-2xl"><c:out value="${list.listName}"/></h2>
            <h2 class="text-base"><c:out value="${list.description}"/></h2>
            <br>
