...
<div class="col-8 offset-2 g-3 p-4 my-8 bg-white shadow-lg rounded-lg">
    <br>
    ...
    <div class="col-6 col-lg-2">
        ...
        <a href=<c:url value="/user/${user.username}"/>>
            <button type="button" class="btn btn-light my-2">Discard Changes</button>
        </a>
    </div>
    <div class="col-6 col-lg-2">
            <%--save changes--%>
        <input type="hidden" name="userId" id="userId" value="<c:out value="${user.userId}"/>">
        <button class="btn btn-secondary my-2" id="editUser" name="editUser" type="submit">Save Changes</button>
    </div>
</div>
</form:form>
</div>
