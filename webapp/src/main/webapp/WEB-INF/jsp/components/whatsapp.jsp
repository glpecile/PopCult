...
<div class="flex flex-col justify-center items-center">
    <div
            class="rounded-full bg-green-400 hover:bg-green-300 w-20 h-20 flex items-center justify-center transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
