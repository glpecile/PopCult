...
<div
        class="rounded-full bg-blue-400 hover:bg-blue-300 h-20 w-auto flex items-center justify-center transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
