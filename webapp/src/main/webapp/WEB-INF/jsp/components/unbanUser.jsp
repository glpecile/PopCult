...
<div>
    <button data-bs-toggle="modal" data-bs-target="#reject${param.id}ModModal">
        <i class="fas fa-times text-xl text-gray-600 hover:text-red-400 cursor-pointer pl-3"
           title="<spring:message code="bans.unban"/>"></i>
    </button>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-bold text-2xl" id="reject${param.id}ModModalLabel">
                        <spring:message code="bans.unban"/>
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <spring:message code="modal.bans.unban"/>
                </div>
                <div class="modal-footer">
                    <c:url value="${param.unbanUserPath}" var="unbanUserPath"/>
                    <form:form cssClass="m-0" action="${unbanUserPath}" method="DELETE">
                        <input type="hidden" name="removeBan">
                        <button type="submit" class="btn btn-danger bg-gray-300 group hover:bg-red-400 text-gray-700 font-semibold hover:text-white"  name="removeBan">
