        ...
        <div class="collapse navbar-collapse flex space-x-8 justify-center items-center text-center sm:justify-end" id="navbarScroll">
            <ul class="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll overflow-hidden">
                <li class="nav-item transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
                    <a class="nav-link active text-lg sm:text-right" aria-current="page" href="<c:url value="/media/films"/>">Films</a>
                </li>
                <li class="nav-item transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
                    <a class="nav-link active text-lg sm:text-right" aria-current="page" href="<c:url value="/media/series"/>">Series</a>
                </li>
                <li class="nav-item transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
                    <a class="nav-link active text-lg sm:text-right" aria-current="page" href="<c:url value="/lists"/>">Lists</a>
                </li>
                <sec:authorize access="!isAuthenticated()">
                    <li class="nav-item transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
                        <a class="nav-link active text-lg sm:text-right" aria-current="page" href="<c:url value="/login"/>">Log-In</a>
                    </li>
                </sec:authorize>
                <sec:authorize access="isAuthenticated()">
                    <c:set var="username">
                    ...
                    <li class="nav-item transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105">
                        <a class="nav-link active text-lg sm:text-right" aria-current="page"
                    ...
                    <%--                        <a class="text-white text-lg sm:text-right nav-link dropdown-toggle"--%>
                    <%--                           role="button"--%>
