...
<head>
    ...
    <title><spring:message code="profile.tabs.toWatchMedia"/> &#8226; PopCult</title>
</head>
            ...
            <c:otherwise>
                <div class="flex-col flex-wrap p-4 space-x-4">
                    ...
                    <h3 class="text-center py-2 mt-0.5 text-gray-400">
                        <spring:message code="profile.toWatchMedia.noMedia"/>
                    </h3>
                </div>
                <c:if test="${currentUsername == user.username}">
                    <div class="row">
                        <h4 class="text-center text-gray-400 py-2">
                            <spring:message code="profile.toWatchMedia.callToAction"/>
                        </h4>
