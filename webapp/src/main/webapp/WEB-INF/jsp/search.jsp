...
<div class="col-8 offset-2">
    ...
    <c:choose>
        <c:when test="${ 0 < (searchSeriesContainer.totalCount + searchFilmsContainer.totalCount + listCoversContainer.totalCount)}">
            <div class="row">
                <h1 class="font-bold text-2xl py-2">There are <c:out value="${searchSeriesContainer.totalCount + searchFilmsContainer.totalCount + listCoversContainer.totalCount}"/> result(s) for <c:out value="${term}"/></h1>
            </div>
            <br>
            ...
            <c:if test="${searchSeriesContainer.totalCount > 0}">
