...
//        List<MediaList> elements = jdbcTemplate.query("SELECT * FROM medialist WHERE userid = ? OFFSET ? LIMIT ?", new Object[]{user, page * pageSize, pageSize}, MEDIA_LIST_ROW_MAPPER);
//        int totalCount = jdbcTemplate.query("SELECT COUNT(*) AS count FROM medialist WHERE userId = ?", new Object[]{user}, COUNT_ROW_MAPPER)
//                .stream().findFirst().orElse(0);
//        return new PageContainer<>(elements, page, pageSize, totalCount);
//    }
//
...
//        List<MediaList> elements = jdbcTemplate.query("SELECT * FROM medialist WHERE userid = ? AND visibility = ? OFFSET ? LIMIT ?", new Object[]{user, true, page * pageSize, pageSize}, MEDIA_LIST_ROW_MAPPER);
//        int totalCount = jdbcTemplate.query("SELECT COUNT(*) AS count FROM medialist WHERE userId = ? AND visibility = ?", new Object[]{user, true}, COUNT_ROW_MAPPER)
//                .stream().findFirst().orElse(0);
//        return new PageContainer<>(elements, page, pageSize, totalCount);
//    }
//
...
//        return jdbcTemplate.query("SELECT * FROM listelement NATURAL JOIN media WHERE mediaListId = ?", new Object[]{mediaList}, MEDIA_ROW_MAPPER);
//    }
//
//    @Override
//    public PageContainer<Media> getMediaIdInList(MediaList mediaList, int page, int pageSize) {
//        List<Media> elements = jdbcTemplate.query("SELECT * FROM listelement NATURAL JOIN media WHERE mediaListId = ? OFFSET ? LIMIT ?", new Object[]{mediaList, pageSize * page, pageSize}, MEDIA_ROW_MAPPER);
//        int totalCount = jdbcTemplate.query("SELECT DISTINCT COUNT(*) AS count FROM listelement WHERE mediaListId = ?", new Object[]{mediaList}, COUNT_ROW_MAPPER)
//                .stream().findFirst().orElse(0);
//        return new PageContainer<>(elements, page, pageSize, totalCount);
//    }
//
...
//                " mediaList WHERE mediaId = ? AND visibility = ? OFFSET ? LIMIT ?", new Object[]{media, true, pageSize * page, pageSize}, MEDIA_LIST_ROW_MAPPER);
//        int totalCount = jdbcTemplate.query("SELECT DISTINCT COUNT(*) AS count FROM listelement NATURAL JOIN medialist WHERE mediaId = ? AND visibility = ?", new Object[]{media, true}, COUNT_ROW_MAPPER)
//                .stream().findFirst().orElse(0);
//        return new PageContainer<>(elements, page, pageSize, totalCount);
//    }
//
...
//                "creationdate  HAVING COUNT(mediaId) >= ? ORDER BY creationdate DESC LIMIT ?", new Object[]{genre, true, minMatches, pageSize}, MEDIA_LIST_ROW_MAPPER);
//    }
//
//    @Override
